...
const handler = async (request) => {
    ...
    if (typeof levelId !== "number" ||
        ...
        sessionId.length < 8) {
        throw new https_1.HttpsError("invalid-argument", "Invalid levelId or sessionId.");
    }
    ...
    try {
        ...
        throw new https_1.HttpsError("internal", "Quota check failed.");
    }
};
exports.handler = handler;
//# sourceMappingURL=checkQuota.js.map